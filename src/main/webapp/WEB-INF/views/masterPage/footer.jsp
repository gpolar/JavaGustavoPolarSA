   ...
   <div class="container-fluid nopadding">
      <div class="row wow fadeInDown" data-wow-delay=".2s" data-wow-offset="10">
         ...
         <div class="col-md-3 cv-link">
            <h4 class="font-accident-two-normal uppercase"><spring:message code="footer_download_cv"/></h4>
            <div class="dividewhite1"></div>
            <a href="index?language=pt"><i class="fa fa-long-arrow-down" aria-hidden="true"></i><spring:message code="footer_idioma_pt"/></a>
            <a href="index?language=en"><i class="fa fa-long-arrow-down" aria-hidden="true"></i><spring:message code="footer_idioma_en"/></a>
            <a href="index?language=es"><i class="fa fa-long-arrow-down" aria-hidden="true"></i><spring:message code="footer_idioma_es"/></a>
            <div class="divider-dynamic"></div>
         </div>
         <!-- <div class="col-md-3">
